...
{
    MT25TL01G_OK = 0,
    MT25TL01G_ERROR_INIT = -1,
    MT25TL01G_ERROR_COMMAND = -2,
    MT25TL01G_ERROR_TRANSMIT = -3,
    MT25TL01G_ERROR_RECEIVE = -4,
    MT25TL01G_ERROR_AUTOPOLLING = -5,
    MT25TL01G_ERROR_MEMORYMAPPED = -6,
} MT25TL01G_StatusTypeDef;
...
#define MT25TL01G_SR_PRBOTTOM                                                                                          \
    ((uint8_t)0x20)                         /* Protected memory area defined by BLOCKPR starts from top                \
                     or bottom */
...
MT25TL01G_StatusTypeDef MT25TL01G_GetFlashInfo(MT25TL01G_InfoTypeDef *pInfo);
MT25TL01G_StatusTypeDef MT25TL01G_Enter4BytesAddressMode(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_Exit4BytesAddressMode(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_AutoPollingMemReady(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_WriteEnable(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_BlockErase(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode,
                                             uint32_t BlockAddress, MT25TL01G_EraseTypeDef BlockSize);
MT25TL01G_StatusTypeDef MT25TL01G_ChipErase(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_PageProgram(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode, uint8_t *pData,
                                              uint32_t WriteAddr, uint32_t Size);
MT25TL01G_StatusTypeDef MT25TL01G_ReadSTR(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode, uint8_t *pData,
                                          uint32_t ReadAddr, uint32_t Size);
MT25TL01G_StatusTypeDef MT25TL01G_ReadDTR(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode, uint8_t *pData,
                                          uint32_t ReadAddr, uint32_t Size);
MT25TL01G_StatusTypeDef MT25TL01G_ReadStatusRegister(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode,
                                                     uint8_t *Value);
MT25TL01G_StatusTypeDef MT25TL01G_EnterQPIMode(QSPI_HandleTypeDef *Ctx);
MT25TL01G_StatusTypeDef MT25TL01G_ExitQPIMode(QSPI_HandleTypeDef *Ctx);

MT25TL01G_StatusTypeDef MT25TL01G_EnableMemoryMappedModeSTR(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_EnableMemoryMappedModeDTR(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_WriteDisable(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_ReadID(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode, uint8_t *ID);

MT25TL01G_StatusTypeDef MT25TL01G_ResetMemory(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_ResetEnable(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);

MT25TL01G_StatusTypeDef MT25TL01G_ReadSPBLockRegister(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode,
                                                      uint8_t *SPBRegister);
MT25TL01G_StatusTypeDef MT25TL01G_ReleaseFromDeepPowerDown(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_EnterDeepPowerDown(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_ProgEraseResume(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
MT25TL01G_StatusTypeDef MT25TL01G_ProgEraseSuspend(QSPI_HandleTypeDef *Ctx, MT25TL01G_InterfaceTypeDef Mode);
