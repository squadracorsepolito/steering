 ...
 *         system can read any address except the block/sector being
 * Program/Erased. SPI/QPI; 1-0-0/4-0-0
 * @param  Ctx Component object pointer
 * @param  Mode Interface mode
 * @retval QSPI memory status
 */
 ...
 *         The device is not active and all Write/Program/Erase instruction are
 * ignored. SPI/QPI; 1-0-0/4-0-0
 * @param  Ctx Component object pointer
 * @param  Mode Interface mode
 * @retval QSPI memory status
 */
