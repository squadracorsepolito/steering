...
#define BSP_QSPI_Info_t MT25TL01G_InfoTypeDef
#define BSP_QSPI_Interface_t MT25TL01G_InterfaceTypeDef
#define BSP_QSPI_Transfer_t MT25TL01G_TransferTypeDef
#define BSP_QSPI_DualFlash_t MT25TL01G_DualFlashTypeDef

typedef enum
{
    BSP_QSPI_ERASE_8K =
        MT25TL01G_ERASE_4K, /*!< 8K size Sector erase = 2 x 4K as Dual flash mode is used for this board   */
    BSP_QSPI_ERASE_64K =
        MT25TL01G_ERASE_32K, /*!< 64K size Sector erase = 2 x 32K as Dual flash mode is used for this board */
    BSP_QSPI_ERASE_128K =
        MT25TL01G_ERASE_64K, /*!< 128K size Sector erase = 2 x 64K as Dual mode is used for this board      */
...
#define BSP_QSPI_SPI_1I2O_MODE                                                                                         \
    (BSP_QSPI_Interface_t) MT25TL01G_SPI_1I2O_MODE /* 1 Cmd Line, 1 Address Line and 2 Data Lines   */
#define BSP_QSPI_SPI_2IO_MODE                                                                                          \
    (BSP_QSPI_Interface_t) MT25TL01G_SPI_2IO_MODE /* 1 Cmd Line, 2 Address Lines and 2 Data Lines  */
#define BSP_QSPI_SPI_1I4O_MODE                                                                                         \
    (BSP_QSPI_Interface_t) MT25TL01G_SPI_1I4O_MODE /* 1 Cmd Line, 1 Address Line and 4 Data Lines   */
#define BSP_QSPI_SPI_4IO_MODE                                                                                          \
    (BSP_QSPI_Interface_t) MT25TL01G_SPI_4IO_MODE                   /* 1 Cmd Line, 4 Address Lines and 4 Data Lines  */
...
int32_t BSP_QSPI_ConfigFlash(BSP_QSPI_Interface_t Mode, BSP_QSPI_Transfer_t Rate);
